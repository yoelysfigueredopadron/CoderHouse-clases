...
const valoresBoolenos = [true, true, false, true, false, false];

// Arreglo mixtos(con diferentes tipos de datos)
const arregloMixto = [100, true, 'Yoelys'];

// console.log(arreglo);
// console.log(arregloNumerico);
// console.log(familiaSimpson);
// console.log(valoresBoolenos);
...
// console.log(arregloNumerico[6]);

// al tratar de acceder a una posición que no existe en el array no va a devolver undefined
// console.log(arregloNumerico[7]);

let suma, suma2;
suma = arregloNumerico[0] + arregloNumerico[4] + arregloNumerico[0];
// console.log(suma);
// console.log(`${arregloNumerico[0]} + ${arregloNumerico[4]} + ${arregloNumerico[0]} = ${suma}`);
...
// Modificaremos la posición 2 en el arreglo mixto el mismo es el último elemento de arreglo que contiene el nombre 'Yoelys' y lo vamos a modificar por 'Juan'
...
// eliminando elementos con splice(), si queremos eliminar elementos en el parámetro cantidad debemos pasar un parámetro mayor que 0. Opcionalmente se pueden agregar más parámetros después de cantidad si se desea agregar nuevos elementos, si estos se omiten no se agregarán elementos con lo cual solo se eliminarán los especificados por los parámetros (indice, cantidad)
...
// después del parámetro cantidad se agregan los que deseamos por ejemplo ('React JS', 'Angular JS', 'Vue JS', 'Node JS')
arregloMixto.splice(1, 0, 'React JS', 'Angular JS', 'Vue JS', 'Node JS');
// arregloMixto.splice(2, 0, 'React JS', 'Angular JS', 'Vue JS', 'Node JS');
// arregloMixto.splice(0, 0, 'React JS', 'Angular JS', 'Vue JS', 'Node JS');
// console.log(arregloMixto);
...
// elementosEliminados = arregloMixto.splice(2, 2);
// console.log(`Elementos eliminados: (${elementosEliminados})`);
...
// const otrosAnimales = ['Leon', 'Tigre', 'Tiburón'];
...
const cursos2 = arregloMixto.slice(1, 5); // obtenemos todos los cursos
// console.log(cursos);
// console.log(cursos2);
...
// includes() devuelve un valor booleano (true/false) tomando un parámetro de entra que se buscará dentro del arreglo si es encontrado devuelve true en caso contrario devuelve false
